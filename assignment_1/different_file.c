...
int main(int argc, char const *argv[]) {
   ...
   * contains the definition of mul_cpx in a file different from the file
     containing the main function, call for instance different_file_mul.c. You
     may not include this file; provide it as an extra argument to the compiler
     instead.
